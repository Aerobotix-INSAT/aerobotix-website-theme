...
<div class="w-full px-6 pt-28 pb-0 container text-center">
    ...
    <div class="font-black text-3xl md:text-5xl break-all mb-5"><?php echo ucwords($curauth->first_name? ($curauth->first_name. ' ' . $curauth->last_name):$curauth->display_name."'s Articles"); ?></div>
