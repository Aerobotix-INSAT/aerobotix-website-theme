...
if (!function_exists('aerobotix_theme_enqueue_scripts')) :
    ...
    function aerobotix_theme_enqueue_scripts()
    {
        ...
        wp_enqueue_style('font-awesome', 'https://use.fontawesome.com/releases/v5.8.1/css/all.css', array(), '5.8.1');
        // Conditionally Enqueue the main JS file.
        if (is_front_page()) {
            wp_enqueue_script('front', get_template_directory_uri() . '/scripts/front-page.js', '1.0.0', false);
        }
        else
            wp_enqueue_script('main', get_template_directory_uri() . '/scripts/main.js',  '1.0.0', true);
    }
